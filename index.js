...
function generateUser(
  ...
  div.innerHTML = `<div class="card-body"><h5 class="card-title">${name}</h5></div><ul class="list-group list-group-flush"><li class="list-group-item">Dizi seviyor: ${
    diziSeviyor == 1 ? "Evet" : "Hayır"
  }</li><li class="list-group-item">Motor seviyor: ${
...
document.getElementById("count").innerHTML = people.length;
...
$(".owl-carousel").owlCarousel({
  ...
  items: Math.floor(document.body.clientWidth / 290),
  center: true,
});

var mainModal;

document.getElementById("openConf").onclick = () => {
  mainModal = new bootstrap.Modal(document.getElementById('epp'), {
    keyboard: false,
    show: false,
  })
  mainModal.show();
...
document.getElementById("match").onclick = () => {
  ...
  if (form.checkValidity()) {
    ...
    let q = people.map((x, y) => {
      ...
      let user = {};
      user[x.name] = y;
      return { input: neurilified, output: user };
    });
    ...
    net.train(q);
    var output = brain.likely(trg, net);
    var output2 = net.run(trg);
    setTimeout(() => {
